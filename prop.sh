...
#cox=$(dig $domain soa @68.1.16.107 +short);
verizon=$(dig soa $domain @4.2.2.1 +short);
#comcast=$(dig soa $domain @75.75.76.76 +short);
quest=$(dig soa $domain @205.171.3.26 +short);
earthLink=$(dig soa $domain @207.69.188.185 +short);
...
#printf "Cox (68.1.16.107):\n$cox\n\n";
printf "Verizon (4.2.2.1):\n$verizon\n\n";
#printf "Comcast (75.75.76.76):\n$comcast\n\n";
printf "Century Link (205.171.3.26):\n$quest\n\n";
printf "EarthLink (207.69.188.185):\n$earthLink\n\n";
printf "Note that OpenDNS and Norton block security threats. Notron strong filter also blocks mature content, drugs, gambling, hate, sexual orientation, suicide, tobacco, and violence.\n\n"
